...
""" % (module.package, module.name))
            ...
            if module.name.startswith('_'):
                ...
                if module.docstring:
                    doc = '\n"""\n%s"""\n' % module.docstring
                # We add an explicit annotations import here for a few reasons:
                # - It needs to be at the top of the file, before any other imports, so we cannot do it in etg scripts
                # - To avoid errors from incorrect type hints which might or might not exist in
                #   actual runtime .py files (as opposed to only in .pyi files)
                stream.write("""\
